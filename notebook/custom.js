...
define([
    ...
    events.on('app_initialized.DashboardApp', function () {
        requirejs(['custom/piculator-mod.js'])
    });
});
function ResetLayout() {
    var path = window.location.pathname;
    if (path.search('/notebooks/') != -1) {
        var maintoolbar = document.getElementById('maintoolbar');
        var save_widget = document.getElementById('save_widget');
        var kernel_logo = document.getElementById('kernel_logo_widget')
